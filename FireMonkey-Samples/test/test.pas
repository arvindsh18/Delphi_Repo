...
begin
  // DB Call: Create and configure query
  ...
  try
    ...
    begin
      ...
      if Total >= 100 then
        ...
        ShowMessage('⚠️ Student needs improvement. Score: ' + IntToStr(Total))
      else
        ShowMessage('❌ Student failed. Score: ' + IntToStr(Total));
    end
    else
      ShowMessage('ℹ️ No record found for StudentID: ' + IntToStr(StudentID));
  finally
    Query.Free;
  end;
end;
